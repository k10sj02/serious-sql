...
_- Insights:
- This shows us that 1 specific customer (shown by `target_values`) ordered 3 times (shown by `row_counts`) while the other 2 customers ordered 6 times respectively.
